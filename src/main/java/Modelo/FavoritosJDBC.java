...
public class FavoritosJDBC {
    ...
    private static final String SQL_INSERT = "INSERT INTO facoritos(user, poke_id) VALUES(?, ?)";
    private static final String SQL_DELETE = "DELETE FROM favoritos WHERE poke_id = ?";
